...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $projectNo = isset($data['projectNo']) ? $data['projectNo'] : null;
    $mos = isset($data['mos']) ? $data['mos'] : null;
    $senderName = isset($data['senderName']) ? $data['senderName'] : null;
    $dispatchRemarks = isset($data['dispatchRemarks']) ? $data['dispatchRemarks'] : null;
    ...
    try {
        ...
        $sql = "INSERT INTO dispatches (customer_name, invoice_no, project_no, mos, sender_name, dispatch_remarks, products) VALUES (?, ?, ?, ?, ? ,? ,?)";
        ...
        $stmt->bind_param("sssssss", $customerName, $invoiceNo, $projectNo, $mos, $senderName, $dispatchRemarks, $jsonProducts);
